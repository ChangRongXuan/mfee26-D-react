...
function Payment(props) {
  ...
  const { 
    ...
    // 切換卡片正反面的 style
    const cardAF = { //卡片正面效果 .front
      perspective:"1000px",
      transform: "rotateY(0deg)"
    }
    const cardAB = { //卡片正面效果 .back
      perspective:"1000px",
      transform: "rotateY(180deg)"
    }
    const cardBF = { //卡片背面效果 .front
      perspective:"1000px",
      transform: "rotateY(-180deg)"
    }
    const cardBB = { //卡片背面效果 .back
      perspective:"1000px",
      transform: "rotateY(0deg)"
    }

    // 預設是卡片正面效果
    const [ cardTransformFront, setCardTransformFront] 
    = useState(cardAF)
    const [ cardTransformBack, setCardTransformBack] 
    = useState(cardAB)
  ...
  // ------------這段處理資料傳進 MySQL 過程-------------------
    ...
    const handleSubmit = (e) => {
      ...
      // 送到伺服器(fetch/ajax)
      fetch("http://localhost:3600/eventcarts/creditcard", {
          method: "POST",
          ...
          <div className="card-container">
            ...
            {/* 這邊會做翻牌變動 */}
              ...
              <div className="front" style={cardTransformFront}>
                  ...
                  <div className="card-number-box">{cardInfor.cardnumber}</div>
                  <div className="flexbox">
                      <div className="box">
                          <span>card holder</span>
                          <div className="card-holder-name">{cardInfor.cardholder}</div>
                      </div>
                      <div className="box">
                          <span>expires</span>
                          <div className="expiration">
                              <span className="exp-month">{cardInfor.ex_month}</span>
                              <span className="exp-year">{cardInfor.ex_year}</span>
                          </div>
                      </div>
                  </div>
              </div>
            ...
            {/* 這邊會做翻牌變動 */}
              ...
              <div className="back" style={cardTransformBack}>
                  ...
                  <div className="box">
                      <span>cvv</span>
                      <div className="cvv-box">{cardInfor.cvv}</div>
                      <img src="image/visa.png" alt=""/>
                  </div>
              </div>
            ...
            >
              ...
              <div className="flexbox">
                  ...
                  <div className="inputBox">
                      ...
                      <select 
                        name="ex_year" id="" className="year-input" 
